      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="http://localhost/php/demo/6221_info.php">6221_Software_Paradigms</a></li>
              <li><a href="http://localhost/php/demo/6111_EAP.php">6111_EAP</a></li>
          </ul>
        </div>
       </div>
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              ...
              <tbody>
				...
				$query ="SELECT * FROM 6221_Advanced_Software_Paradigms;";
